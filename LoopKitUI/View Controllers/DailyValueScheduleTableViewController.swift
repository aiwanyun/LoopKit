        ...
        didSet {
            ...
            if timeZoneDiff != 0 {
                ...
                navigationItem.prompt = String(
                    format: LocalizedString("时间在 %1$@%2$@%3$@", comment: "The schedule table view header describing the configured time zone difference from the default time zone. The substitution parameters are: (1: time zone name)(2: +/-)(3: time interval)"),
