...
public struct BasalRatesInformationView: View {
    ...
    private var text: some View {
        VStack(alignment: .leading, spacing: 25) {
            ...
            Text(String(format: LocalizedString("%1$@ 支持每天 1 至 %2$@ 费率。", comment: "Information about max number of basal rates (1: app name) (2: maximum schedule entry count)"), appName, String(describing: maximumScheduleEntryCount)))
